...
PhySimInterferenceHelper::Event::Event (Ptr<const Packet> packet, Ptr<PhySimWifiPhyTag> tag)
...
bool
PhySimInterferenceHelper::Event::Overlaps (Ptr<const PhySimInterferenceHelper::Event> other) const
{
  Time s1 = this->GetStartTime();
  Time e1 = this->GetEndTime();

  Time s2 = other->GetStartTime();
  Time e2 = other->GetEndTime();
...
Ptr<const Packet>
PhySimInterferenceHelper::Event::GetPacket (void) const
{
  return m_packet;
}
...
PhySimInterferenceHelper::Add (Ptr<Packet> packet, Ptr<PhySimWifiPhyTag> tag)
{
  ...
  Ptr<PhySimInterferenceHelper::Event> event = Create<PhySimInterferenceHelper::Event> (packet, tag);
  AppendEvent (event);
...
const std::list< Ptr<PhySimInterferenceHelper::Event> >&
PhySimInterferenceHelper::GetEvents (void) const
{
  return m_events;
}
